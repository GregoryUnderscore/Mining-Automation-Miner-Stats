-- Sorted by estimated profit (descending).
...
-- The most profitable algorithm will be at the top (estimated 24 hour profit).
...
ORDER BY (price*profit_estimate*(average_stat.mh_factor / pools.mh_factor)*average_work) DESC; -- ESTIMATE